...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
REM INSERTING into LFEHER.SZEREP
SET DEFINE OFF;
...
REM INSERTING into LFEHER.USER_SZEREP
SET DEFINE OFF;
...
REM INSERTING into LFEHER.USERS
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  ALTER TABLE "LFEHER"."USER_SZEREP" ADD CONSTRAINT "USER_SZEREP_FK3" FOREIGN KEY ("U2R_SZER_ID")
	  REFERENCES "LFEHER"."SZERVEZET" ("SZER_ID") ENABLE;
